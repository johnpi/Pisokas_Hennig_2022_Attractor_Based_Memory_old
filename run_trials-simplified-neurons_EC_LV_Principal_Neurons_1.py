...
network_parameters_dict = {
     #256: (256,   64, 1.0, [0.000618624974, 0.04, 0.8, 8.0, 9.58639314, 1.0, 1.5]),
     256: (256,   64, 1.0, [0.00159845390, 0.0666432083, 0.826643199, 2.09866259, 7.0, 1.0, 1.5]),
     #256: (256,   64, 4.0, [0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5]),
     #256: (256,   64, 4.0, [0.00159845390, 0.0666432083, 0.826643199, 2.09866259, 7.0, 1.0, 1.5]),    
     512: (512,  128, 4.0, [0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5]),
    1024: (1024, 256, 2.0, [0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5]),
    2048: (2048, 512, 1.0, [0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5]),
    4096: (4096, 1024,0.5, [0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5]),
    8192: (8192, 2048,0.25,[0.0001, 0.005, 0.1, 1.33962449,  7.0, 1.0, 1.5])
}

# Values common for all sizes
# Entry structure
#         (N_excitatory, N_inhibitory, weight_scaling_factor, [G_inhib2inhib, G_inhib2excit, G_excit2excit, G_excit2inhib, g_coop, G_extern2excit, stimulus_strength])
network_parameters_dict = {
     128: (128,   32, 16.0,[0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
     256: (256,   64, 8.0, [0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
     512: (512,  128, 4.0, [0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
    1024: (1024, 256, 2.0, [0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
    2048: (2048, 512, 1.0, [0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
    4096: (4096, 1024,0.5, [0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5]),
    8192: (8192, 2048,0.25,[0.0001, 0.005, 0.11, 1.33962449,  7.0, 1.0, 1.5])
}
                ...
                for trial in range(1, N_trials+1):
                    ...
                    if network_param is None:
                        ...
                        if len(network_param) == 3:
                            ...
                            G_inhib2inhib, G_inhib2excit, G_excit2excit, G_excit2inhib, g_coop, G_extern2excit, stimulus_strength = network_param[3]
                            run_trials(num_of_trials         = 1,
                                       collected_data_file   = filename,
                                       stimulus_center_deg   = stim_heading_degrees,
                                       N_excitatory          = network_param[0],
