...
collected_data_file = 'Data/collected_drift_trials_v2_Ne8192_noise.npy' # The file to store the collected trials data
...
synaptic_noise_amount_list = [0.0, 0.001, 0.01, 0.1]
synaptic_noise_amount_list = [0.0]
