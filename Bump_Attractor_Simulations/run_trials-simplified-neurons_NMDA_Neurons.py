...
collected_data_file = 'Data/collected_drift_trials_v2_NMDA.npy' # The file to store the collected trials data


def run_trials(num_of_trials         = 20, 
               collected_data_file   = 'Data/collected_drift_trials_NMDA.npy',
...
network_parameters_dict = {
    ...
    4096: (4096, 1024,0.5, [.35 * 1.024, .35 * 1.336, .35 * 0.381, .35 * 1.2 * 0.292,  2.38, 3.1, 1.5]),
    8192: (8192, 2048,0.25,[.35 * 1.024, .35 * 1.336, .35 * 0.381, .35 * 1.2 * 0.292,  2.38, 3.1, 1.5])
}
...
parser.add_argument('--tau_m', type=float, nargs='+', dest='tau_m', default=[-1], 
