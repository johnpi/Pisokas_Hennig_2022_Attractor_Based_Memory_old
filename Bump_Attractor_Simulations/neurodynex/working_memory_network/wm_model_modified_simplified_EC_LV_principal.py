...
def simulate_wm(
    ...
    # If a tau_excit value is provided change the capacitance accordingly
    ...
    # If a tau_inhib value is provided change the capacitance accordingly
    if tau_inhib is not None:
        Cm_inhib = tau_inhib * G_leak_inhib
